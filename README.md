## **Statistical Analysis: NYC Taxi Fare and Payment Type**
...
Application: This statistical approach can be applied to my own business, 'Herb House', to analyze booking patterns between different platforms.
